...
public class SupplierDetailDAOImpl implements SupplierDetailDAO {
    ...
    public boolean save(SupplierDetail entity) throws SQLException, ClassNotFoundException {
        return SQLUtil.execute("INSERT INTO supplier_detail (supplier_id, rawMaterial_id, date, unit_price,qty ) VALUES (?,?,?,?,?)", entity.getSupplierId(), entity.getRawMaterialId(),entity.getDate(),entity.getUnitPrice(),entity.getQtyOnStock() );
    }
